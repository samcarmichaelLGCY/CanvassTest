describe('template spec', () => {
  it('Login As Sam Nav to Configure > Import Interactions', () => {
   ...
   //navagate to Configure > Import Interactions
   cy.get('li.menu-item:nth-child(12) > a:nth-child(1) > span:nth-child(2)').click()
   cy.get('li.menu-item:nth-child(12) > div:nth-child(2) > ul:nth-child(1) > li:nth-child(7) > a:nth-child(1) > span:nth-child(2)').click()
