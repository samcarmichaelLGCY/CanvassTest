describe('template spec', () => {
  it('Login As Sam Nav to Leaderboards', () => {
    ...
    cy.get('div.box:nth-child(1) > div:nth-child(2) > input:nth-child(2)').type('fc@canvass.com')
   ...
   //navagate to Leaderboards
   cy.get('#kt_aside_menu > ul > li:nth-child(2) > a > span.menu-text').click()
   cy.url().should('include', '/leaderboards')
   
   cy.wait(2000)
   cy.get('#radio-inputs > div > label:nth-child(2) > span').click()
