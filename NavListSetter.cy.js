describe('template spec', () => {
  it('Login As Sam Nav to Lists', () => {
    ...
    cy.get('div.box:nth-child(1) > div:nth-child(2) > input:nth-child(2)').type('fs@canvass.com')
   ...
   //navagate to Lists
   cy.get('#kt_aside_menu > ul > li:nth-child(6) > a > span.menu-text').click()
