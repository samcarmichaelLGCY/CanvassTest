describe('template spec', () => {
  it('Login As Sam Nav to Area', () => {
   ...
   //navagate to User Management > Area    
   cy.get('.menu-nav > li:nth-child(10) > a:nth-child(1) > span:nth-child(2)').click()
   cy.url().should('include', '/area')
  })
})
