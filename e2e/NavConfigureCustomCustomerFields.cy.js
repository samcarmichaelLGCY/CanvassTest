describe('template spec', () => {
  it('Login As Sam Nav to Configure > Custom Customer Fields', () => {
   ...
   //navagate to Configure > Custom Customer Fields 
   cy.get('li.menu-item:nth-child(12) > a:nth-child(1) > span:nth-child(2)').click()
   cy.get('li.menu-item:nth-child(4) > a:nth-child(1) > span:nth-child(2)').click()
   cy.url().should('include', '/customFields')
  })
})