describe('template spec', () => {
  it('Login As Sam Nav to Configure > Pipeline Stages', () => {
   ...
   //navagate to Configure > Pipeline Stages
   cy.get('li.menu-item:nth-child(12) > a:nth-child(1) > span:nth-child(2)').click()
   cy.get('li.menu-item:nth-child(12) > div:nth-child(2) > ul:nth-child(1) > li:nth-child(10) > a:nth-child(1) > span:nth-child(2)').click()
